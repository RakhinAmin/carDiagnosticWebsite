...
import SmellsResponse from "../../components/response/SmellsResponse";

// Define the BrakesPage component
function SmellsPage() {
  // State to store the user's selection (Yes or No), set to null
  const [inputSmells, setInputSmells] = useState(false);
      ...
      >
        ...
        <div className="home__buttons">
          ...
          <button
            ...
            onClick={() => setInputSmells(!inputSmells)}
          >
            Yes
          </button>
          {inputSmells && <SmellsResponse />}
